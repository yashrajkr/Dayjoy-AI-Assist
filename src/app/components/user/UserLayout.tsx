  ...
  return (
    <TooltipProvider delayDuration={200}>
      ...
      <div className="h-[100dvh] flex bg-background">
        ...
        <aside
          id="dj-user-drawer"
          className={`fixed lg:static inset-y-0 left-0 z-[45] w-72 sm:w-80 ${collapsed ? "lg:w-[76px]" : "lg:w-72"} bg-card lg:glass border-r border-border flex flex-col transition-[transform,width] duration-200 ease-[cubic-bezier(0.22,1,0.36,1)] scrollbar-thin
